  ...
  <section id='about' className='section-about'>
    <Grid className='outer-grid'>
      <Row className='main-row'>
        <p className='about-intro green-text'>A place to learn, collaborate and become a software developer</p>
        <p className='lead about-p2'>Tri-Valley Coders is a comfortable non-competitive place to learn about making software, both in person and online. We cater to beginners and vetrans alike. Our members span the gammute in terms of age and experience, but they all have one thing in common, they are learning something new, taking their software development skills to the next level and getting ready for the next step in their career.</p>
        ...
        <Button bsStyle='success'> <img src={iMeetup} width={45} alt='meetup logo'/><span className='join-us-text'>Join Us via Meetup!</span></Button>
      </Row>
    </Grid>
  </section>
)
