  ...
  <section id='about' className='section-about'>
    <Grid className='outer-grid'>
      <Row className='main-row'>
        ...
        {/* <Button className='join-us-btn' bsStyle='success' bsSize='large'> <img src={iMeetup} width={50} alt='meetup logo'/><span className='join-us-text'></span>Join Us via Meetup!</Button> */}
      </Row>
    </Grid>
  </section>
)
