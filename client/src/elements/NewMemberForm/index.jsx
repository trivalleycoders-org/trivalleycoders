...
const NewMemberForm = React.createClass({
  getInitialState() {
    return initialState;
  },
  ...
  //   // console.log(nextState.firstNameValid);
  //   // console.log(firstValid);
  //   if(
  //     nextState.firstNameValid == firstValid ||
  //     nextState.lastNameValid == lastValid ||
  //     nextState.passwordValid == passValid ||
  //     nextState.roleValid == roValid ||
  //     nextState.emailValid == emValid
  //     ) {
  //     console.log("false");
  //     return false;
  //   }
